...
function showAns(answer) {
    inp1 = (Math.round(answer * 1000000000) / 1000000000).toString();
    display(inp1);
    inp2 = "";
    isInp1 = true;
    setOperation("");
...
function display(input) {
    ...
    document.getElementById("input-number").innerText = input;
}
function setOperation(input){
    document.getElementById("operation-symbol").innerText = input;
}
